...
def init_db():
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS users (
        id INTEGER PRIMARY KEY, name TEXT, username TEXT, joined_date TEXT)""")
    cur.execute("""CREATE TABLE IF NOT EXISTS admins (id INTEGER PRIMARY KEY)""")
    cur.execute("""CREATE TABLE IF NOT EXISTS channels (
        id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT UNIQUE)""")
    cur.execute("""CREATE TABLE IF NOT EXISTS movies (
        id INTEGER PRIMARY KEY AUTOINCREMENT, movie_id TEXT UNIQUE, name TEXT, photo_id TEXT)""")
    cur.execute("""CREATE TABLE IF NOT EXISTS parts (
        id INTEGER PRIMARY KEY AUTOINCREMENT, movie_id TEXT, part_num INTEGER,
        name TEXT, video_id TEXT, caption TEXT, download_count INTEGER DEFAULT 0)""")
